...
MonsterTable(13)=(bSetup=True,MonsterName="Alien",MonsterClassName="tk_Alien.M_Alien",NumSpawns=0,NumDamage=0,NumKills=0,NewHealth=150,NewMaxHealth=150,NewGroundSpeed=900.00,NewAirSpeed=440.00,NewWaterSpeed=220.00,NewJumpZ=100.00,NewScoreAward=10,NewGibMultiplier=1.00,NewGibSizeMultiplier=1.00,NewDrawScale=1.40,NewCollisionHeight=59.00,NewCollisionRadius=25.00,NewPrePivot=(X=0.00,Y=0.00,Z=0.00),DamageMultiplier=1.00,bRandomHealth=False,bRandomSpeed=False,bRandomSize=False,CurrentSkin=)
MonsterTable(14)=(bSetup=True,MonsterName="Alien Queen",MonsterClassName="tk_Alien.M_AlienQueen",NumSpawns=0,NumDamage=0,NumKills=0,NewHealth=600,NewMaxHealth=600,NewGroundSpeed=800.00,NewAirSpeed=440.00,NewWaterSpeed=220.00,NewJumpZ=100.00,NewScoreAward=20,NewGibMultiplier=1.00,NewGibSizeMultiplier=1.00,NewDrawScale=1.60,NewCollisionHeight=105.00,NewCollisionRadius=45.00,NewPrePivot=(X=0.00,Y=0.00,Z=-22.00),DamageMultiplier=1.00,bRandomHealth=False,bRandomSpeed=False,bRandomSize=False,CurrentSkin=)
MonsterTable(15)=(bSetup=True,MonsterName="Predator",MonsterClassName="tk_Predator.M_PredatorArmed",NumSpawns=0,NumDamage=0,NumKills=0,NewHealth=100,NewMaxHealth=100,NewGroundSpeed=440.00,NewAirSpeed=440.00,NewWaterSpeed=220.00,NewJumpZ=340.00,NewScoreAward=10,NewGibMultiplier=1.00,NewGibSizeMultiplier=1.00,NewDrawScale=1.40,NewCollisionHeight=60.00,NewCollisionRadius=25.00,NewPrePivot=(X=0.00,Y=0.00,Z=-5.00),DamageMultiplier=1.00,bRandomHealth=False,bRandomSpeed=False,bRandomSize=False,CurrentSkin=)
MonsterTable(16)=(bSetup=True,MonsterName="Predator Unmasked",MonsterClassName="tk_Predator.M_PredatorArmedUnmasked",NumSpawns=0,NumDamage=0,NumKills=0,NewHealth=100,NewMaxHealth=100,NewGroundSpeed=440.00,NewAirSpeed=440.00,NewWaterSpeed=220.00,NewJumpZ=340.00,NewScoreAward=10,NewGibMultiplier=1.00,NewGibSizeMultiplier=1.00,NewDrawScale=1.40,NewCollisionHeight=60.00,NewCollisionRadius=25.00,NewPrePivot=(X=0.00,Y=0.00,Z=-5.00),DamageMultiplier=1.00,bRandomHealth=False,bRandomSpeed=False,bRandomSize=False,CurrentSkin=)
MonsterTable(17)=(bSetup=True,MonsterName="Predator Hunter",MonsterClassName="tk_Predator.M_PredatorArmedHunter",NumSpawns=0,NumDamage=0,NumKills=0,NewHealth=500,NewMaxHealth=500,NewGroundSpeed=440.00,NewAirSpeed=440.00,NewWaterSpeed=220.00,NewJumpZ=340.00,NewScoreAward=10,NewGibMultiplier=1.00,NewGibSizeMultiplier=1.00,NewDrawScale=1.40,NewCollisionHeight=60.00,NewCollisionRadius=25.00,NewPrePivot=(X=0.00,Y=0.00,Z=-5.00),DamageMultiplier=1.00,bRandomHealth=False,bRandomSpeed=False,bRandomSize=False,CurrentSkin=)
MonsterTable(18)=(bSetup=True,MonsterName="Predator Killer",MonsterClassName="tk_Predator.M_PredatorArmedKiller",NumSpawns=0,NumDamage=0,NumKills=0,NewHealth=500,NewMaxHealth=500,NewGroundSpeed=440.00,NewAirSpeed=440.00,NewWaterSpeed=220.00,NewJumpZ=340.00,NewScoreAward=10,NewGibMultiplier=1.00,NewGibSizeMultiplier=1.00,NewDrawScale=1.40,NewCollisionHeight=60.00,NewCollisionRadius=25.00,NewPrePivot=(X=0.00,Y=0.00,Z=-5.00),DamageMultiplier=1.00,bRandomHealth=False,bRandomSpeed=False,bRandomSize=False,CurrentSkin=)

MonsterTable(19)=(bSetup=True,MonsterName="Lucifer",MonsterClassName="2009Lucifer.LuciferMonster",NumSpawns=0,NumDamage=0,NumKills=0,NewHealth=600,NewMaxHealth=600,NewGroundSpeed=400.00,NewAirSpeed=440.00,NewWaterSpeed=220.00,NewJumpZ=340.00,NewScoreAward=20,NewGibMultiplier=1.00,NewGibSizeMultiplier=1.00,NewDrawScale=2.00,NewCollisionHeight=110.00,NewCollisionRadius=50.00,NewPrePivot=(X=0.00,Y=0.00,Z=-25.00),DamageMultiplier=1.00,bRandomHealth=False,bRandomSpeed=False,bRandomSize=False,CurrentSkin="Texture'2009LuciferAnims.LuciferSkinNew'")
