class FireDragonExplode extends DragonExplode;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         ColorMultiplierRange=(Y=(Min=0.400000,Max=0.200000),Z=(Min=0.000000,Max=0.000000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'tk_2009Dragonv2.FireDragonExplode.SpriteEmitter3'
     ...
     End Object
     Emitters(1)=SpriteEmitter'tk_2009Dragonv2.FireDragonExplode.SpriteEmitter4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter5
         ...
         UseVelocityScale=True
         ColorMultiplierRange=(Y=(Min=0.400000,Max=0.800000),Z=(Min=0.400000,Max=0.400000))
         CoordinateSystem=PTCS_Relative
         ...
         Texture=Texture'tk_2009Dragonv2.SFX.FireSprite'
         LifetimeRange=(Min=1.000000,Max=1.000000)
         StartVelocityRadialRange=(Min=-1000.000000,Max=-1000.000000)
         GetVelocityDirectionFrom=PTVD_AddRadial
         VelocityScale(0)=(RelativeVelocity=(X=0.200000,Y=0.200000,Z=0.200000))
     ...
     End Object
     Emitters(2)=SpriteEmitter'tk_2009Dragonv2.FireDragonExplode.SpriteEmitter5'
