class UT2004RPGKeyBinding extends GUIUserKeyBinding;

defaultproperties
{
     KeyData(0)=(KeyLabel="UT2004 RPG",bIsSection=True)
     ...
     KeyData(6)=(Alias="mutate ghostsuicide",KeyLabel="Ghost Suicide")
}
