class STY_AbilityList extends GUI2Styles;

defaultproperties
{
     KeyName="AbilityList"
     Begin Object Class=AbilityListFont Name=AbilityMenuFont
     End Object
     Fonts(0)=AbilityListFont'UT2004RPG.STY_AbilityList.AbilityMenuFont'

     Fonts(1)=AbilityListFont'UT2004RPG.STY_AbilityList.AbilityMenuFont'

     Fonts(2)=AbilityListFont'UT2004RPG.STY_AbilityList.AbilityMenuFont'

     Fonts(3)=AbilityListFont'UT2004RPG.STY_AbilityList.AbilityMenuFont'

     Fonts(4)=AbilityListFont'UT2004RPG.STY_AbilityList.AbilityMenuFont'
