/** Ability Adrenal Junky **
*This is a Ability dedicated to the *Adrenaline Master* and *Medic Master* Class
*This ability has 20 levels with 4 Key Levels
*Level 5 : Gain The Adrenaline g
*
*
*
*/

class AbilityAdrenalJunky extends RPGAbility
	abstract;
...
defaultproperties
{
     AbilityName="Adrenal Junky"
     Description="For each level of this ability, you gain 10% more adrenaline from all kill related adrenaline bonuses. You must have a Damage Bonus of at least 50 and an Adrenaline Max stat at least 150 to purchase this ability. (Max Level: 2)"
     StartingCost=20
     CostAddPerLevel=20
     MaxLevel=20
}
