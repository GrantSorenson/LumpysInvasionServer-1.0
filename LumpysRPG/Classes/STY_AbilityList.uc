...
defaultproperties
{
     ...
     End Object
     Fonts(0)=AbilityListFont'LumpysRPG.STY_AbilityList.AbilityMenuFont'
     Fonts(1)=AbilityListFont'LumpysRPG.STY_AbilityList.AbilityMenuFont'
     Fonts(2)=AbilityListFont'LumpysRPG.STY_AbilityList.AbilityMenuFont'
     Fonts(3)=AbilityListFont'LumpysRPG.STY_AbilityList.AbilityMenuFont'
     Fonts(4)=AbilityListFont'LumpysRPG.STY_AbilityList.AbilityMenuFont'
     FontColors(0)=(G=195)
