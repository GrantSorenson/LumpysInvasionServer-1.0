...
var localized string MasterClass;
 ...
 */
static function bool AbilityIsAllowed(GameInfo Game, MutLumpysRPG RPGMut)
{
	return true;
}
...
//Helpers for starting and stopping Ability related FX, return type represent success or failure
