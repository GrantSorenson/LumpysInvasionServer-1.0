//ArtifactManagerV2 will be used instead of this artifact manager
//The implementation for this class has been disbaled in the Mutator file

class LumpysArtifactManager extends Info config(LumpyRPG);
...
defaultproperties
{
     ...
     MaxArtifacts=10
     MaxHeldArtifacts=99
     AvailableArtifacts(0)=(ArtifactClass=Class'LumpysRPG.ArtifactInvulnerability',Chance=1)
     AvailableArtifacts(1)=(ArtifactClass=Class'LumpysRPG.ArtifactFlight',Chance=5)
     AvailableArtifacts(2)=(ArtifactClass=Class'LumpysRPG.ArtifactTripleDamage',Chance=2)
     AvailableArtifacts(3)=(ArtifactClass=Class'LumpysRPG.ArtifactLightningRod',Chance=3)
     //AvailableArtifacts(4)=(ArtifactClass=Class'LumpysRPG.ArtifactTeleport',Chance=1)
