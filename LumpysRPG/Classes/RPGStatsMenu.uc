...
{
	Controller.OpenMenu("LumpysRPG.RPGPlayerLevelsMenu");
...
function InitFor(RPGStatsInv Inv)
{
	...
	for (x = 0; x < StatsInv.AllAbilities.length; x++)
	{
		...
		if (StatsInv.AllAbilities[x].default.AbilityName == "Medic Master" )
		{
...
{
	Controller.OpenMenu("LumpysRPG.RPGResetConfirmPage");
...
defaultproperties
{
		 ...
		 //bPersistent=true;// If set, page is saved across open/close/reopen.
		 bRenderWorld=True//False - don't render anything behind this menu / True - render normally (everything)
		 bAllowedAsLast=True// If this is true, closing this page will not bring up the main menu
     ...
     End Object
     Controls(0)=FloatingImage'LumpysRPG.RPGStatsMenu.FloatingFrameBackground'
     ...
     End Object
     Controls(1)=GUIButton'LumpysRPG.RPGStatsMenu.CloseButton'
     ...
     Begin Object Class=moEditBox Name=WeaponSpeedSelect
         ...
         WinHeight=0.040000
     End Object
     Controls(2)=moEditBox'LumpysRPG.RPGStatsMenu.WeaponSpeedSelect'
     ...
     Begin Object Class=moEditBox Name=HealthBonusSelect
         ...
         WinHeight=0.040000
     End Object
     Controls(3)=moEditBox'LumpysRPG.RPGStatsMenu.HealthBonusSelect'
     ...
     Begin Object Class=moEditBox Name=AdrenalineMaxSelect
         ...
         WinHeight=0.040000
     End Object
     Controls(4)=moEditBox'LumpysRPG.RPGStatsMenu.AdrenalineMaxSelect'
     ...
     Begin Object Class=moEditBox Name=AttackSelect
         ...
         WinHeight=0.040000
     End Object
     Controls(5)=moEditBox'LumpysRPG.RPGStatsMenu.AttackSelect'
     ...
     Begin Object Class=moEditBox Name=DefenseSelect
         ...
         WinHeight=0.040000
     End Object
     Controls(6)=moEditBox'LumpysRPG.RPGStatsMenu.DefenseSelect'
     ...
     Begin Object Class=moEditBox Name=MaxAmmoSelect
         ...
         WinHeight=0.040000
     End Object
     Controls(7)=moEditBox'LumpysRPG.RPGStatsMenu.MaxAmmoSelect'
     ...
     Begin Object Class=moEditBox Name=PointsAvailableSelect
         ...
         IniOption="@INTERNAL"
		 		...
		 		WinTop=0.799510
     End Object
     Controls(8)=moEditBox'LumpysRPG.RPGStatsMenu.PointsAvailableSelect'
//=======================Control plus buttons============================9-14
     ...
     End Object
     Controls(9)=GUIButton'LumpysRPG.RPGStatsMenu.WeaponSpeedButton'
     ...
     End Object
     Controls(10)=GUIButton'LumpysRPG.RPGStatsMenu.HealthBonusButton'
     ...
     End Object
     Controls(11)=GUIButton'LumpysRPG.RPGStatsMenu.AdrenalineMaxButton'
     ...
     End Object
     Controls(12)=GUIButton'LumpysRPG.RPGStatsMenu.AttackButton'
     ...
     End Object
     Controls(13)=GUIButton'LumpysRPG.RPGStatsMenu.DefenseButton'
     ...
     End Object
     Controls(14)=GUIButton'LumpysRPG.RPGStatsMenu.AmmoMaxButton'
//=========================End control plus buttons=============================
     ...
     End Object
     Controls(15)=GUIButton'LumpysRPG.RPGStatsMenu.LevelsButton'
//Start Ability Controls=======================================
     ...
     End Object
     Controls(16)=GUIListBox'LumpysRPG.RPGStatsMenu.AbilityList'
     ...
     End Object
     Controls(17)=GUIButton'LumpysRPG.RPGStatsMenu.AbilityDescButton'
     ...
     End Object
     Controls(18)=GUIButton'LumpysRPG.RPGStatsMenu.AbilityBuyButton'
...
// End Ability Controls==========================================
     ...
     End Object
     Controls(19)=GUIEditBox'LumpysRPG.RPGStatsMenu.WeaponSpeedThing'
     ...
     End Object
     Controls(20)=GUIEditBox'LumpysRPG.RPGStatsMenu.HealthBonusThing'
     ...
     End Object
     Controls(21)=GUIEditBox'LumpysRPG.RPGStatsMenu.AdrenalineMaxThing'
     ...
     End Object
     Controls(22)=GUIEditBox'LumpysRPG.RPGStatsMenu.AttackThing'
     ...
     End Object
     Controls(23)=GUIEditBox'LumpysRPG.RPGStatsMenu.DefenseThing'
     ...
     End Object
     Controls(24)=GUIEditBox'LumpysRPG.RPGStatsMenu.MaxAmmoThing'
//===================================
     ...
     End Object
     Controls(25)=GUIButton'LumpysRPG.RPGStatsMenu.ResetButton'
     ...
     // Controls(27)=GUILabel'UT2004RPG.RPGStatsMenu.EXPLabel'
		 ...
		 End Object
		 Controls(26)=GUIButton'LumpysRPG.RPGStatsMenu.AbilitiesButton'
		 ...
		 End Object
		 Controls(27)=GUIButton'LumpysRPG.RPGStatsMenu.StatsButton'
		 ...
		 Begin Object Class=GUIButton Name=StoreButton
				 ...
				 OnKeyEvent=ResetButton.InternalOnKeyEvent
		 End Object
		 Controls(28)=GUIButton'LumpysRPG.RPGStatsMenu.StoreButton'
		 ...
		 Begin Object Class=GUIScrollTextBox Name=DescInfo
				...
				bNeverFocus=True
		End Object
		Controls(29)=GUIScrollTextBox'LumpysRPG.RPGStatsMenu.DescInfo'
