...
static simulated function ModifyPawn(Pawn Other, int AbilityLevel)
{
    ...
    defaultproperties
    {
        ...
        Description="Regenerate Ammo for all Non-Super weapons|Levels 1-5 of this ability generate ammo every second|Levels 6-10 of this ability generate ammo every 3 seconds|Levels 11-15 generate ammo every 5 seconds"
        StartingCost=20
        CostAddPerLevel=5
        MaxLevel=15
    }