class LilLadyTwoAltProj extends Projectile;
...
//	if ( Level.NetMode != NM_DedicatedServer && Level.NetMode != NM_ListenServer)
	...
	{
		AltSmokeTrail = Spawn(class'AltLilLadyTwoTrail',self);
	}
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
	...
	{
		Spawn(class'LilLadyTwoAltBlows',,, HitLocation, rotator(HitNormal));
	}
	BlowUp(HitLocation);
...
defaultproperties
{
     DamageTypeHead=Class'LumpyRPGWeapons.DamTypeHeadShot'
     Speed=15000.000000
     MaxSpeed=16000.000000
     Damage=400.000000
     DamageRadius=10.000000
     MomentumTransfer=100.000000
     MyDamageType=Class'LumpyRPGWeapons.DamTypeAltLilLadyTwo'
