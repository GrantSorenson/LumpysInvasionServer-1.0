...
class SSRminiProjBall extends Emitter;
var() class<SSRminiProjBall> xEmitter;
#exec OBJ LOAD FILE=SSRminiBallProj2.utx
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         StartSizeRange=(X=(Min=45.000000,Max=45.000000),Y=(Min=65.000000,Max=65.000000),Z=(Min=65.000000,Max=65.000000))
				 ...
				 //Texture=Texture'SSRminiBallProj2.SSRminiBall2.SSRminiCore1'
				 Texture=Texture'RainbowShockRifleTex.RainbowShockRifle.RainbowNew_core_low'
         LifetimeRange=(Min=0.350000,Max=0.350000)
         WarmupTicksPerSecond=20.000000
         RelativeWarmupTime=1.000000
     End Object
     Emitters(0)=SpriteEmitter'LumpyRPGWeapons.SSRminiProjBall.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         //Texture=Texture'SSRminiBallProj2.SSRminiBall2.SSRminiLiquidFlare1'
				 Texture=Texture'RainbowShockRifleTex.RainbowShockRifle.RainbowFlare'
         LifetimeRange=(Min=0.400000,Max=0.400000)
         WarmupTicksPerSecond=20.000000
         RelativeWarmupTime=1.000000
     End Object
     Emitters(1)=SpriteEmitter'LumpyRPGWeapons.SSRminiProjBall.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         StartSizeRange=(X=(Min=4.500000,Max=4.500000))
				 ...
				 //Texture=Texture'SSRminiBallProj2.SSRminiBall2.SSRminiCore1'
         Texture=Texture'RainbowShockRifleTex.RainbowShockRifle.RainbowCore'
         LifetimeRange=(Min=0.350000,Max=0.350000)
         ...
         RelativeWarmupTime=1.000000
     End Object
     Emitters(2)=SpriteEmitter'LumpyRPGWeapons.SSRminiProjBall.SpriteEmitter2'
