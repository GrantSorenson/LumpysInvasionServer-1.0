class LilLadyTwoProj extends Projectile;
...
//	if ( Level.NetMode != NM_DedicatedServer && Level.NetMode != NM_ListenServer)
	...
	{
		SmokeTrail = Spawn(class'LilLadyTwoTrail',self);
		Corona = Spawn(class'LilLadyTwoCorona',self);
	}
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
	...
	{
	    bingo = Spawn(class'LilLadyTwoBlows',,,HitLocation + HitNormal*16,rotator(HitNormal));
...
defaultproperties
{
     ...
     MyDamageType=Class'LumpyRPGWeapons.DamTypeLilLadyTwo'
