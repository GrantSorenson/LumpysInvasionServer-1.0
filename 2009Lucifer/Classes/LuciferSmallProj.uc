...
class LuciferSmallProj extends Projectile
  Placeable;

var LuciferSmallProjTrail NewTrail;
var Actor Seeking;
...
simulated function PostBeginPlay ()
{
  ...
  if ( Level.NetMode != 1 )
  {
    NewTrail = Spawn(Class'LuciferSmallProjTrail',self,,,Rotation);
...
simulated function Explode (Vector HitLocation, Vector HitNormal)
{
  ...
  PlaySound(Sound'LuciferProjExplode',SLOT_Ambient,1.0);
  Spawn(Class'LuciferSmallProjExplode',,);
