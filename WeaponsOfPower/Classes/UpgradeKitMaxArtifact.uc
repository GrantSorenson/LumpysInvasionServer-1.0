class UpgradeKitMaxArtifact extends WeaponOfPowerArtifact;
...
defaultproperties
{
    ...
    AllowRepair=True
    AllowUpgradeToWop=True
    Description="Utility that will upgrade weapons to the maximum level."
    PickupClass=Class'UpgradeKitMaxPickup'
    IconMaterial=Texture'WeaponsOfPowerTextures.Icons.UpgradeKitIconRed'
    ItemName="Red Wrench"
}
