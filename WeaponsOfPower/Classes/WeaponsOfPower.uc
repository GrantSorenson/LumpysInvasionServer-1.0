...
function class<Weapon> GetRandomWeaponClass(
	...
	do {
		...
		(
			...
			(
				(bAllowSupers == True) ||
				(class'MutLumpysRPG'.static.IsSuperWeaponAmmo(RandomWeapon.default.FireModeClass[0].default.AmmoClass) == False)
			)
		) ||
		(iSanity > 100)
	);
...
simulated function Tick(float deltaTime) {
	foreach DynamicActors(class'MutLumpysRPG', RPGMutator) {
		break;
	}
