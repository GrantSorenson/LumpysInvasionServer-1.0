class UpgradeKitArtifact extends WeaponOfPowerArtifact;
...
function bool Apply() {
	...
	if ((("" $ Weapon.class.name) == "RPGWeapon")) {
		...
		NewWeapon.Modifier = class'WeaponsOfPower.WeaponOfPower'.default.MinModifier;
...
defaultproperties
{
    ...
    Description="Utility that will upgrade weapons one unit at a time or make a Weapon of Power.||This can be applied multiple times."
    PickupClass=Class'UpgradeKitPickup'
    IconMaterial=Texture'WeaponsOfPowerTextures.Icons.UpgradeKitIcon'
    ItemName="Gold Wrench"
}
